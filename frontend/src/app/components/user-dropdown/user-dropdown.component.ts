...
export class UserDropdownComponent implements OnInit {
  ...
  ngOnInit() {
    this.popper.innerHTML = `<div class="bg-white text-base z-60 float-left py-2 list-none text-left rounded shadow-lg mt-1" style="min-width:12rem" #popoverDropdownRef>
  <a href="#pablo" class="text-sm py-2 px-4 font-normal block w-full  bg-transparent  text-gray-800">
    Action
  </a>
